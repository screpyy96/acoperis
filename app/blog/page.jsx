...
export default function ComingSoonBlog() {
  return (
    <Layout>
      <div className="min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-gray-50 to-teal-50">
        <div className="container mx-auto px-4 py-16 text-center">
          {/* Icon sau Ilustrație */}
          <div className="mb-8 relative w-24 h-24 mx-auto">
            <Image
              src="/images/pattern.svg" // adaugă o icoană potrivită
              alt="Blog Icon"
              fill
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Blog-ul nostru va fi disponibil în curând!
          </h1>

          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Pregătim articole informative despre acoperișuri, sfaturi pentru întreținere,
            și noutăți din domeniu. Reveniți în curând!
          </p>

          {/* Newsletter Signup opțional */}
          <div className="max-w-md mx-auto mb-12">
            <p className="text-sm text-gray-500 mb-4">
              Abonați-vă pentru a fi notificat când lansăm blog-ul:
            </p>
          ...
          <div className="mt-12">
            <p className="text-sm text-gray-500 mb-4">
              Urmăriți-ne pe rețelele sociale pentru noutăți:
            </p>
